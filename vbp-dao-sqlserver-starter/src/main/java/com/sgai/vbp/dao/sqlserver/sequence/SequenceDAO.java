package com.sgai.vbp.dao.sqlserver.sequence;
...
public class SequenceDAO extends SqlServerDAOSupport<SequenceBean> implements IdSequenceService {
	...
	private SequenceBean getNext(SequenceBean sequenceBean) {
		sequenceBean.setModifyTime(DateTimeUtils.getCurTimestamp());
		sequenceBean.setSequence(sequenceBean.getSequence()+sequenceBean.getStep());
